...
public class FragmentMenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mylocation = (FloatingActionButton) findViewById(R.id.fab_location);
    ...
    protected void onMyMapReady(final GoogleMap googleMap) {
...
//                    MIN_DISTANCE_CHANGE_FOR_UPDATES, ( LocationListener ) this);
    ...
    public abstract class Fragmentmap extends AppCompatActivity implements LocationListener {
        private static final String MYTAG = "MYTAG";
